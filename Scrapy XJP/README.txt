purpose: to create a general spider that can scrapy data from Html and AJAX

Requirement:
1. spider can scrapy data from URL provided by user
1-1. if there's no related module to parser the URL provided then it should feedback the msg

2. to create 2 spcific spiders, one is for collecting data from XINHUN & RENMIN about XIjinPing, another one is for collect Realestimate price from Royal 
...
4. The second spider can collect the data as well as to store in SQL  (not finish)
4-1. also the data could be analyzed
